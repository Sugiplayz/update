...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        const prompt = `Analyze the following news text for signs of fake news, misinformation, or bias. Provide a concise assessment, clearly stating whether it appears 'Likely Genuine', 'Likely Fake', or 'Uncertain'. Just say it even if its not on your own knowledge surf through the web and give feed back.
